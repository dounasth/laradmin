        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120"
                     alt="">
                {{ Form::open(array('route' => 'activate', 'method' => 'get', 'class'=>'form-signin')) }}

                    {{ Form::text('email', '', array('placeholder'=>'Email', 'class'=>'form-control', 'required'=>'', 'autofocus'=>'')); }}

                    {{ Form::text('activationCode', '', array('placeholder'=>'Activation Code', 'class'=>'form-control', 'required'=>'')); }}
